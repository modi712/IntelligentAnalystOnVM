...
FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS="llmchatbot"
...
sudo cp "/home/azureuser/$PROJECT_MAIN_DIR_NAME/nginx/nginx.conf" "/etc/nginx/sites-available/$FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS"
...
# Add www-data user to azureuser group
sudo gpasswd -a www-data azureuser
